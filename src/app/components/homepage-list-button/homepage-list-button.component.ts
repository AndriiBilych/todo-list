...
@Component({
  ...
  template: `
    <li class="px-4 py-6 grid grid-cols-2 sm:grid-cols-5 sm:gap-4 sm:px-0 h-32 rounded-lg hover:bg-blue-100 group transition cursor-pointer"
        (click)="createBoard()">
      <span class="flex justify-center items-center font-medium text-lg leading-6 sm:col-span-2 group-hover:text-gray-500 text-gray-900 bg-blue-100 rounded-lg">
